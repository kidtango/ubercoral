...
class CoralsDetail extends Component {
  ...
  render() {
    const { showModal, toastMessage, toast } = this.state;
              ...
              <Modal
                ...
                footer={
                  <Box
                    ...
                    wrap
                  >
                    <Box align='center' color='transparent' size='sm'>
                      <ToastMessage
                        show={toast}
                    ...
                    {coral.quantity ? (
                      <Button
                        ...
                        color='blue'
                        onClick={() => {
                          addToCart({ type: 'ADD_TO_CART', payload: coral });
                          this.showToast('Uber Coral Added');
                        }}
                      />
                    ) : (
                      <Button
