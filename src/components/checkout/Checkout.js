        ...
        <Column span={9}>
          <Box color="lightWash" padding={1}>
            ...
            <Box color="white" padding={3}>
              ...
              <Box display="flex">
                <Text align="left" color="orange" bold>Orange Passion </Text>
                <IconButton
              ...
              <Text align="left">Item #: BV343312</Text>
              <Text align="left">Ships from: Houston</Text>
              <Text align="left">Price: $599.99</Text>
            </Box>
            <Box color="white" padding={3}>
              <Text align="left" color="orange" bold>Homewrecker</Text>
              <Text align="left">Item #: GT443312</Text>
              <Text align="left">Ships from: Houston</Text>
              <Text align="left">Price: $599.99</Text>
            </Box>
            <Box color="white" padding={3}>
              <Text align="left" color="orange" bold>Walt Disney</Text>
              <Text align="left">Item #: KT343312</Text>
              <Text align="left">Ships from: Houston</Text>
              <Text align="left">Price: $599.99</Text>
            </Box>
            <Divider />
            <Box color="blue" padding={3}>
              <Text color="white" align="left" bold>Total: $1999.99</Text>
            </Box>
          </Box>
        </Column>
        <Column span={3} />
